...
@Document(collection = "chemistry_lib")
@ToString
public class ChemistryExerciseEntity extends BaseExerciseEntity {
    ...
    public ChemistryExerciseEntity(String _id, String yiji, String erji, String content, String answer, String type, AnalysisSet analysis, List<String> choose, List<Integer> answer_index) {
