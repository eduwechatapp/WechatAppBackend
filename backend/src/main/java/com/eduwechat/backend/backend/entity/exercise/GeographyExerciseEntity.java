...
@Document(collection = "geography_lib")
@ToString
public class GeographyExerciseEntity extends BaseExerciseEntity {
    ...
    public GeographyExerciseEntity(String _id, String yiji, String erji, String content, String answer, String type, AnalysisSet analysis, List<String> choose, List<Integer> answer_index) {
