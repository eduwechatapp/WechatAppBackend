...
public interface ChineseExerciseDao extends JpaRepository<ChineseExerciseEntity, Integer> {
     ...
     * @return List&lt;String&gt;
     */
    @Query(value = "SELECT yiji FROM chinese_lib GROUP BY yiji", nativeQuery = true)
     ...
     * @return List&lt;String&gt;
     */
    @Query(value = "SELECT erji FROM chinese_lib WHERE yiji = :yiji GROUP BY erji", nativeQuery = true)
     ...
     */
    List<ChineseExerciseEntity> findByYijiAndErji(String yiji, String erji, Pageable pageable);
