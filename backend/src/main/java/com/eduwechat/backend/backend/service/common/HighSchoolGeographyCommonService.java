...
import com.eduwechat.backend.backend.entity.common.HighSchoolGeography;
...
@Service
public class HighSchoolGeographyCommonService extends BaseCommonService {
    ...
    public HighSchoolGeography getArticleFromErjiAndTitle(String title) throws ArticleNotFoundException {
        ...
        return (HighSchoolGeography) list.get(0);
    }
}
