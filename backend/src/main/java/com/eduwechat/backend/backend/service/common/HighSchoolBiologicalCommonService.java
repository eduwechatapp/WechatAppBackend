...
import com.eduwechat.backend.backend.entity.common.HighSchoolBiological;
...
public class HighSchoolBiologicalCommonService extends BaseCommonService {
     ...
     */
    @Override
    public HighSchoolBiological getArticleFromErjiAndTitle(String erji, String title) throws ArticleNotFoundException {
         ...
         return (HighSchoolBiological) list.get(0);
    }
