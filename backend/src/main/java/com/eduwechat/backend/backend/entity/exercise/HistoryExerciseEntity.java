...
@Document(collection = "history_lib")
@ToString
public class HistoryExerciseEntity extends BaseExerciseEntity {
    ...
    public HistoryExerciseEntity(String _id, String yiji, String erji, String content, String answer, String type, AnalysisSet analysis, List<String> choose, List<Integer> answer_index) {
        super(_id, yiji, erji, content, answer, type, analysis, choose, answer_index);
    }

    public HistoryExerciseEntity() {
    }
}
