...
@Document(collection = "chinese_lib")
@ToString
public class ChineseExerciseEntity extends BaseExerciseEntity {
    ...
    public ChineseExerciseEntity(String _id, String yiji, String erji, String content, String answer, String type, AnalysisSet analysis, List<String> choose, List<Integer> answer_index) {
