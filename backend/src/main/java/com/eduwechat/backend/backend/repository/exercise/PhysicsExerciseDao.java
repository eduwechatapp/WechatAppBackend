...
public interface PhysicsExerciseDao extends JpaRepository<PhysicsExerciseEntity, Integer> {
     ...
     * @return List&lt;String&gt;
     */
    @Query(value = "SELECT yiji FROM physics_lib GROUP BY yiji", nativeQuery = true)
     ...
     * @return List&lt;String&gt;
     */
    @Query(value = "SELECT erji FROM physics_lib WHERE yiji = :yiji GROUP BY erji", nativeQuery = true)
     ...
     */
    List<PhysicsExerciseEntity> findByYijiAndErji(String yiji, String erji, Pageable pageable);
