...
public class HighSchoolChemistry implements BaseEntity {
    ...
    public HighSchoolChemistry(String yiji, String erji, String sanji, String title, Integer shoucang_int, Integer level_int, String content) {
        this.yiji = yiji;
        this.erji = erji;
        this.sanji = sanji;
        this.title = title;
