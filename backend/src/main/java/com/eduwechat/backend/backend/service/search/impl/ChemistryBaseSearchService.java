...
/**
 * @program: backend
 * @description: ChemistryBaseSearchService
 * @author: Vaskka
 * @create: 2019/5/15 2:58 AM
 **/
@Service
public class ChemistryBaseSearchService extends BaseSearchService implements FullSearchable {

    @Autowired
    private HighSchoolChemistryRepository searchDao;
    ...
    public SearchResult fullSearch(String erji, String titleKeyWord, String contentKeyWord, Integer size, Integer page) {
        ...
        return this.innerFromSubjectGetSearchResult(page, size, "hx", seachResult);
    }
