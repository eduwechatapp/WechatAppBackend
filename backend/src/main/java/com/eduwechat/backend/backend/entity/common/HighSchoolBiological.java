...
@Entity
@Table(name = "gzsw")
public class HighSchoolBiological implements BaseCommonEntity {
    ...
    public HighSchoolBiological(String yiji, String erji, String sanji, String title, Integer shoucang_int, Integer level_int, String content) {
        this.yiji = yiji;
        this.erji = erji;
        this.sanji = sanji;
        this.title = title;
