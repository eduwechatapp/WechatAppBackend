...
/**
 * @program: backend
 * @description: ChineseBaseSearchService
 * @author: Vaskka
 * @create: 2019/5/15 3:00 AM
 **/
@Service
public class ChineseBaseSearchService extends BaseSearchService implements FullSearchable {

    @Autowired
    private HighSchoolChineseRepository searchDao;
    ...
    public SearchResult fullSearch(String erji, String titleKeyWord, String contentKeyWord, Integer size, Integer page) {
        ...
        return this.innerFromSubjectGetSearchResult(page, size, "yw", seachResult);
    }
