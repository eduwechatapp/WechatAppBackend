...
@Table(name = "gzyy")
@Entity
public class HighSchoolEnglish implements BaseCommonEntity {
    ...
    public HighSchoolEnglish(String yiji, String erji, String sanji, String title, Integer shoucang_int, Integer level_int, String content) {
        this.yiji = yiji;
        this.erji = erji;
        this.sanji = sanji;
        this.title = title;
