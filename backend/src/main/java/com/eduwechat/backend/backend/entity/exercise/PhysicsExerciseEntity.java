...
@Document(collection = "physics_lib")
@ToString
public class PhysicsExerciseEntity extends BaseExerciseEntity {
    ...
    public PhysicsExerciseEntity(String _id, String yiji, String erji, String content, String answer, String type, AnalysisSet analysis, List<String> choose, List<Integer> answer_index) {
