...
public interface PoliticsExerciseDao extends JpaRepository<PoliticsExerciseEntity, Integer> {
     ...
     * @return List&lt;String&gt;
     */
    @Query(value = "SELECT yiji FROM politics_lib GROUP BY yiji", nativeQuery = true)
     ...
     * @return List&lt;String&gt;
     */
    @Query(value = "SELECT erji FROM politics_lib WHERE yiji = :yiji GROUP BY erji", nativeQuery = true)
     ...
     */
    List<PoliticsExerciseEntity> findByYijiAndErji(String yiji, String erji, Pageable pageable);
