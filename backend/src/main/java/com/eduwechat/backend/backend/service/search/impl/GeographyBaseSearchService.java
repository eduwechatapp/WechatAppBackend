...
/**
 * @program: backend
 * @description: GeographyBaseSearchService
 * @author: Vaskka
 * @create: 2019/5/15 3:00 AM
 **/
@Service
public class GeographyBaseSearchService extends BaseSearchService implements FullSearchable {

    @Autowired
    private HighSchoolGeographyRepository searchDao;
    ...
    public SearchResult fullSearch(String erji, String titleKeyWord, String contentKeyWord, Integer size, Integer page) {
        ...
        return this.innerFromSubjectGetSearchResult(page, size, "dl", seachResult);
    }
