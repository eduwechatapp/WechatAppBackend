...
/**
 * @program: backend
 * @description: EnglishBaseSearchService
 * @author: Vaskka
 * @create: 2019/5/15 3:00 AM
 **/
@Service
public class EnglishBaseSearchService extends BaseSearchService implements FullSearchable {

    @Autowired
    private HighSchoolEnglishRepository searchDao;
    ...
    public SearchResult fullSearch(String erji, String titleKeyWord, String contentKeyWord, Integer size, Integer page) {
        ...
        return this.innerFromSubjectGetSearchResult(page, size, "yy", seachResult);
    }
