...
@Repository
public interface HighSchoolPoliticalRepository extends BaseCommonRepository<HighSchoolPolitical, Integer> {
     ...
     * @return Page&lt;HighSchoolBiological&gt;
     */
    Page<BaseCommonEntity> findByYiji(String yiji, Pageable pageable);
