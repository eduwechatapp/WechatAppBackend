...
@Document(collection = "politics_lib")
@ToString
public class PoliticsExerciseEntity extends BaseExerciseEntity {
    ...
    public PoliticsExerciseEntity(String _id, String yiji, String erji, String content, String answer, String type, AnalysisSet analysis, List<String> choose, List<Integer> answer_index) {
        super(_id, yiji, erji, content, answer, type, analysis, choose, answer_index);
    }

    public PoliticsExerciseEntity() {
    }
}
