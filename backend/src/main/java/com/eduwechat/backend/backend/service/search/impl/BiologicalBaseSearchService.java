...
@Service
public class BiologicalBaseSearchService extends BaseSearchService implements FullSearchable {

    @Autowired
    private HighSchoolBiologicalRepository searchDao;
    ...
    public SearchResult fullSearch(String erji, String titleKeyWord, String contentKeyWord, Integer size, Integer page) {
        ...
        return this.innerFromSubjectGetSearchResult(page, size, "sw", seachResult);
    }
